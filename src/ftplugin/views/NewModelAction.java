...
public class NewModelAction extends Action implements IWorkbenchAction {
	...
	public void run() {
		FTModel model = FTModel.createBSSModel();
		FTView.displayModel(model.getRootElement());
		viewer = new TreeViewer(
				StructureView.composite);
		viewer.setContentProvider(new FTContentProvider());
		viewer.setLabelProvider(new FTLabelProvider());
