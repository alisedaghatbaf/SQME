...
public class ATView extends ViewPart {
	...
	static void createNodes(ModelElement root) {
		IFigure figure = root.createFigure();
			
		figure.setFont( new Font(graph.getDisplay(),"Tahoma", 6,0));
		root.node = new CGraphNode(graph, SWT.NONE, figure);
